...
const s: Record<string, CSSProperties> = {
  ...
  sideFooter:  { padding: '10px 12px', borderTop: '1px solid rgba(255,255,255,.08)', display: 'flex', flexDirection: 'column', gap: 8 },
  sideSection: { display: 'flex', flexDirection: 'column', gap: 7, padding: 10, borderRadius: 14, border: '1px solid rgba(255,255,255,.08)', background: 'rgba(255,255,255,.03)' },
  sideGroupCashier: { background: 'rgba(59,130,246,.06)', borderColor: 'rgba(96,165,250,.12)' },
  sideGroupOps: { background: 'rgba(16,185,129,.05)', borderColor: 'rgba(52,211,153,.12)' },
  sideGroupStore: { background: 'rgba(245,158,11,.06)', borderColor: 'rgba(251,191,36,.14)' },
  sideGroupSettings: { background: 'rgba(148,163,184,.05)', borderColor: 'rgba(148,163,184,.12)' },
  ...
  sideFutureTools: { padding: '8px 10px', borderRadius: 10, border: '1px dashed rgba(148,163,184,.24)', color: '#94a3b8', fontSize: 11, lineHeight: 1.45, background: 'rgba(15,23,42,.18)' },
  sidePrimaryBtn: { minHeight: 42, padding: '0 12px', borderRadius: 12, border: '1px solid rgba(96,165,250,.22)', background: 'rgba(37,99,235,.16)', color: '#dbeafe', fontSize: 14, fontWeight: 900, cursor: 'pointer', textAlign: 'left' as const },
  sideSecondaryBtn: { minHeight: 34, padding: '0 12px', borderRadius: 10, border: '1px solid rgba(255,255,255,.10)', background: 'rgba(255,255,255,.06)', color: '#e2e8f0', fontSize: 12, fontWeight: 780, cursor: 'pointer', textAlign: 'left' as const },
  sideMutedBtn: { minHeight: 30, padding: '0 10px', borderRadius: 10, border: '1px dashed rgba(255,255,255,.10)', background: 'rgba(255,255,255,.03)', color: '#94a3b8', fontSize: 11, fontWeight: 700, cursor: 'pointer', textAlign: 'left' as const },
  holdCard: { padding: 10, borderRadius: 12, background: 'rgba(239,246,255,.10)', border: '1px solid rgba(96,165,250,.18)', color: '#e2e8f0' },
  ...
  shiftCard: { padding: 10, borderRadius: 12, background: 'rgba(236,253,245,.10)', border: '1px solid rgba(52,211,153,.18)', color: '#e2e8f0' },
  shiftStart: { marginBottom: 8, fontSize: 12, fontWeight: 900, color: '#f8fafc' },
  shiftBtn: { width: '100%', minHeight: 34, borderRadius: 10, border: '1px solid rgba(96,165,250,.18)', background: 'rgba(37,99,235,.12)', color: '#dbeafe', fontSize: 12, fontWeight: 900, cursor: 'pointer' },
  ...
  fxCard: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, padding: '9px 10px', borderRadius: 12, background: 'rgba(254,243,199,.09)', border: '1px solid rgba(251,191,36,.16)', color: '#e2e8f0', minWidth: 0 },
  ...
  autoPrintToggle: { display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) auto', alignItems: 'center', gap: 10, minHeight: 52, padding: '8px 10px', borderRadius: 12, background: 'rgba(148,163,184,.06)', border: '1px solid rgba(148,163,184,.14)', color: '#e2e8f0' },
  autoPrintText: { display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 1, minWidth: 0, minHeight: 32 },
  autoPrintTitle: { fontSize: 12, fontWeight: 800, color: '#f8fafc', lineHeight: 1.15 },
  autoPrintSub: { fontSize: 10, color: '#94a3b8', lineHeight: 1.2, minHeight: 13 },
