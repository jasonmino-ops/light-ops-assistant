...
const s: Record<string, CSSProperties> = {
  ...
  pcard:       { background: '#fff', borderRadius: 10, overflow: 'hidden', cursor: 'pointer', border: '1.5px solid transparent', transition: 'all .12s', userSelect: 'none' as const, display: 'flex', flexDirection: 'column' as const, minHeight: 180 },
  ...
  pcardImg:    { height: 90, flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 32, overflow: 'hidden' },
