...
const s: Record<string, CSSProperties> = {
  ...
  pcard:       { background: '#fff', borderRadius: 10, overflow: 'hidden', cursor: 'pointer', border: '1.5px solid transparent', transition: 'all .12s', userSelect: 'none' as const, display: 'flex', flexDirection: 'column' as const },
