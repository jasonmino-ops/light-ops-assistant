...
const PUBLIC_PATH_PREFIXES = ['/start', '/open', '/bind', '/relogin', '/menu', '/m', '/e-life', '/me', '/v', '/p', '/creator/p', '/cashier', '/desktop', '/records', '/privacy', '/terms', '/contact', '/lead', '/mino-bos/assets-check']
