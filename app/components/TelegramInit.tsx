...
// /cashier and /desktop are standalone PC pages — no Telegram session required
const PUBLIC_EXACT_PATHS = ['/']
const PUBLIC_PATH_PREFIXES = ['/start', '/open', '/bind', '/relogin', '/menu', '/m', '/e-life', '/me', '/v', '/p', '/creator/p', '/cashier', '/desktop', '/privacy', '/terms', '/contact']
