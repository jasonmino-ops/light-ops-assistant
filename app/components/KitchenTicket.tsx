...
/**
 * Existing 80mm KitchenTicket content, exposed as pure HTML for QZ Tray.
 * There is deliberately no browser-print path in this controlled QZ flow.
 */
export function renderKitchenTicketHtml(data: KitchenTicketData, lang: Lang): string {
