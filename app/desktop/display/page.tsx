...
const s: Record<string, CSSProperties> = {
  ...
  staticKhqrFrame: { position: 'relative', flex: 1, minWidth: 0, minHeight: 0, width: '100%', boxSizing: 'border-box', overflow: 'hidden', display: 'grid', placeItems: 'center', margin: 'clamp(6px, .8vw, 11px) 0', padding: 4, borderRadius: 14, background: '#fff', border: '1px solid #dbeafe' }, staticKhqrFrameKhqr: { border: '2px solid #60a5fa', boxShadow: '0 10px 22px rgba(37,99,235,.15)' }, staticKhqrImage: { position: 'absolute', inset: 4, display: 'block', width: 'calc(100% - 8px)', height: 'calc(100% - 8px)', maxWidth: 400, maxHeight: 'calc(100% - 8px)', margin: 'auto', objectFit: 'contain', borderRadius: 8 }, noKhqr: { maxWidth: 180, color: '#64748b', fontSize: 'clamp(12px, 1.1vw, 15px)', fontWeight: 700, lineHeight: 1.5 }, paymentHint: { color: '#334155', fontSize: 'clamp(11px, 1.15vw, 15px)', fontWeight: 850, lineHeight: 1.4 }, paymentInstruction: { marginTop: 5, color: '#1d4ed8', fontSize: 'clamp(11px, 1.15vw, 15px)', fontWeight: 950, lineHeight: 1.4 },
