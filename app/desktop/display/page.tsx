...
const s: Record<string, CSSProperties> = {
  ...
  payCard: { flex: 1, background: '#fff', borderRadius: 14, padding: 18, display: 'flex', flexDirection: 'column', boxShadow: '0 1px 3px rgba(0,0,0,.05)', minHeight: 0 },
  ...
  idleShowcase: { minHeight: '100%', display: 'flex', flexDirection: 'column', gap: 12 },
  idleHero: { borderRadius: 18, padding: 22, minHeight: 190, background: 'linear-gradient(135deg, #0f172a 0%, #1e3a8a 56%, #2563eb 100%)', color: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center', boxShadow: '0 18px 38px rgba(15,23,42,.18)', overflow: 'hidden', flexShrink: 0 },
  ...
  idleStore: { marginTop: 14, fontSize: 38, lineHeight: 1.05, fontWeight: 900, letterSpacing: '-1px' },
  idleWelcome: { marginTop: 8, fontSize: 20, fontWeight: 800, color: '#bfdbfe' },
  idleSub: { marginTop: 6, fontSize: 14, color: '#dbeafe' },
