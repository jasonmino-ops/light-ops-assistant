...
/**
 * /desktop?storeCode=XXX — 门店大屏镜像视图（只读）
 *
  ...
  if (noCode) {
    return (
      <div style={s.errScreen}>
        ...
        <div style={s.errSub}>请使用 /desktop?storeCode=&lt;门店编号&gt; 打开本页。</div>
      </div>
    )
  }
    ...
    <div style={s.root}>
      ...
      <div style={s.header}>
        ...
        <div style={s.headerCenter}>
          ...
          <div style={s.storeCode}>门店编号 {data?.storeCode ?? storeCode ?? '—'} · 镜像自手机销售页</div>
        </div>
...
function IdleCard() {
  return (
    <div style={s.bigCard}>
      ...
      <div style={s.bigTitle}>等待新订单</div>
      <div style={s.bigSub}>店员在手机端扫码 / 选商品后会实时同步到本屏</div>
    </div>
  )
}
