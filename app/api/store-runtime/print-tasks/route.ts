...
import { STORE_RUNTIME_NO_STORE_HEADERS, readStoreRuntimeJson, storeRuntimeErrorResponse } from '@/lib/store-runtime/http'
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(result, { status: result.created ? 201 : 200, headers: STORE_RUNTIME_NO_STORE_HEADERS })
  } catch (error) {
