...
export async function POST(
  ...
  const initialAuthorization = await authorizeTransaction(req, { operation: 'PAYMENT_CANCEL' })
  ...
  const authorization = await authorizeTransaction(req, { operation: 'PAYMENT_CANCEL', store: {
