...
import { retryProductImportJob } from '@/lib/product-bulk-import/confirm'
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    return NextResponse.json(await retryProductImportJob(context.tenantId, id), { headers: noStoreHeaders })
  } catch (error) {
