...
assert.deepEqual(config, {
  ...
  git: { deploymentEnabled: { 'codex/es-network-server-v01-release': false } },
});
...
console.log('PASS exact Network release branch automatic deployment disabled; main and other branches unchanged');
