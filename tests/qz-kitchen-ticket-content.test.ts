...
assert.match(html, /font-family:\s*"Arial", "Segoe UI", "Noto Sans Khmer", "Khmer OS Battambang", "Microsoft YaHei", "PingFang SC", sans-serif/)
assert.match(html, /font-weight:\s*600/)
assert.match(html, /border-top:\s*1\.2px dashed #000/)
assert.match(html, /\.item-name \{ font-size: 13px; font-weight: 900/)
