export const COPY = {
  zh: {
    ...
    rule: '柬埔寨专项口径 · Asia/Phnom_Penh。今日、昨日、自定义及日报：每天 06:00～24:00；本周、本月：从周一或月初 06:00 连续统计至查询时刻。',
    ...
    product: '商品', store: '门店', quantity: '销售数量', amount: '商品销售额', refund: '已记录商品退款额', totals: '按币种合计', generated: '生成时间', print: '打印', printFailed: '无法打开打印，请允许弹出窗口或使用支持打印的浏览器。',
  ...
  en: {
    ...
    rule: 'Cambodia reporting · Asia/Phnom_Penh. Today, yesterday, custom dates and daily reports: 06:00–24:00 each day. Week/month: continuously from Monday/day 1 at 06:00 to query time.',
    ...
    product: 'Product', store: 'Store', quantity: 'Quantity sold', amount: 'Product sales', refund: 'Recorded product refunds', totals: 'Totals by currency', generated: 'Generated', print: 'Print', printFailed: 'Printing is unavailable. Allow popups or use a browser that supports printing.',
  ...
  km: {
    ...
    rule: 'សម្រាប់កម្ពុជា · Asia/Phnom_Penh។ ថ្ងៃនេះ ម្សិលមិញ ថ្ងៃជ្រើសរើស និងរបាយការណ៍ប្រចាំថ្ងៃ៖ 06:00–24:00។ សប្ដាហ៍/ខែ៖ ចាប់ពីថ្ងៃចន្ទ/ថ្ងៃទី១ ម៉ោង06:00 ដល់ពេលស្វែងរក។',
    ...
    product: 'ទំនិញ', store: 'ហាង', quantity: 'ចំនួនលក់', amount: 'ប្រាក់លក់ទំនិញ', refund: 'ប្រាក់សងវិញតាមទំនិញ', totals: 'សរុបតាមរូបិយប័ណ្ណ', generated: 'ពេលបង្កើត', print: 'បោះពុម្ព', printFailed: 'មិនអាចបោះពុម្ពបាន។ សូមអនុញ្ញាតផ្ទាំងថ្មី ឬប្រើកម្មវិធីដែលគាំទ្រការបោះពុម្ព។',
