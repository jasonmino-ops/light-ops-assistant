...
assert.equal(unknown.effectBoundary, "CROSSING_UNKNOWN");
...
assert.equal(disconnectDuringCommand.effectBoundary, "CROSSING_UNKNOWN");
...
assert.equal(timeout.effectBoundary, "CROSSING_UNKNOWN");
